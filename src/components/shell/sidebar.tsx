...
import { Cpu, Globe, LayoutDashboard, MessageSquareText, PlayCircle, ScanSearch, Settings2, Swords } from "lucide-react";
...
const NAV = [
  ...
  { href: "/engines", label: "Moteurs", icon: Cpu },
  { href: "/prompts", label: "Thèmes et prompts", icon: MessageSquareText },
  { href: "/competitors", label: "Concurrents", icon: Swords },
